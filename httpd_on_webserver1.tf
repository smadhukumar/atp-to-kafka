resource "null_resource" "LiveLabWebserver1HTTPD" {
 depends_on = [oci_core_instance.LiveLabWebserver1]
 provisioner "remote-exec" {
        connection {
                type     = "ssh"
                user     = "opc"
		        host     = data.oci_core_vnic.LiveLabWebserver1_VNIC1.public_ip_address
  ...
  inline = ["echo '== 1. Installing HTTPD package with yum'",
            ...
            "sudo /bin/su -c \"echo 'Welcome to LiveLab.com! This is WEBSERVER1...' > /var/www/html/index.html\"",
